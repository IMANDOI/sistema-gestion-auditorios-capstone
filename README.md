...
## Producto Mínimo Viable (MVP): Sistema Autónomo de Gestión Operativa, Trazabilidad, Medición de Horas Utilizadas de TI, Analítica y SOC para Auditorios
...
### Resumen del MVP, Problemática Operativa, Horas de TI y Ciberseguridad
...
1. **Control y Registro Exacto de Horas Utilizadas de TI:** Reduce el tiempo de espera del personal de soporte técnico de hasta **1 hora a menos de 30 segundos** mediante validación presencial por **códigos QR dinámicos**, registrando con precisión matemática el tiempo real de soporte dedicado por evento (`checkoutTime - checkInTime`).
...
4. **Dashboard de Analítica Cuantitativa:** Sustituye opiniones y quejas subjetivas por **métricas duras (horas utilizadas de TI, estrellas 1-5, NPS, tasa de ocupación real)**.
...
1. 📄 **[informe_fase_1_definicion_proyecto.md](file:///c:/Users/MAANDO/Desktop/PROYECTO%20DE%20TITULO/objetos%20proyecto%20de%20titulo/informe_fase_1_definicion_proyecto.md)**:
   ...
   * **Contenido:**
     ...
     * **Parte III:** Arquitectura de software, marco de ciberseguridad (OWASP / ISO 27001), Centro de Control SOC, Balance de horas utilizadas de TI, Diagrama de Casos de Uso, Diagrama C4 de Contenedores y Modelo Entidad-Relación relacional con tabla `SecurityAuditLog`.
...
2. 📄 **[especificacion_requerimientos.md](file:///c:/Users/MAANDO/Desktop/PROYECTO%20DE%20TITULO/objetos%20proyecto%20de%20titulo/especificacion_requerimientos.md)**:
   ...
   * **Contenido:**
     ...
     * 16 Requerimientos Funcionales del MVP (RF-01 a RF-16, incluyendo Centro de Control SOC, Cómputo de Horas TI y Explorador de Logs).
