...
## Producto Mínimo Viable (MVP): Sistema Autónomo de Gestión Operativa, Trazabilidad, Analítica y Ciberseguridad para Auditorios

Este directorio contiene todos los artefactos de ingeniería, especificaciones técnicas, modelos de persistencia, estándares de ciberseguridad y entregables oficiales para el desarrollo del Proyecto de Título.

---

### Resumen del MVP, Problemática Operativa y Ciberseguridad
El proyecto es un **Producto Mínimo Viable (MVP) funcional de arquitectura autónoma y genérica (*White-Label*)**, aplicable a cualquier centro universitario, de formación técnica o complejo corporativo. Su objetivo es validar empíricamente la resolución de problemas operacionales críticos bajo un **marco robusto de ciberseguridad (OWASP Top 10 / ISO 27001)**:
...
5. **Ciberseguridad y Protección de Datos Sensibles:** Hashing de contraseñas con `bcrypt` (factor >= 10), tokens JWT cifrados (JWE) en cookies `HttpOnly`/`Secure`/`SameSite=Lax`, consultas parametrizadas con Prisma ORM (anti SQLi), validación en servidor con Zod y cabeceras HTTP defensivas (HSTS, CSP, X-Frame-Options).
...
1. 📄 **[informe_fase_1_definicion_proyecto.md](file:///c:/Users/MAANDO/Desktop/PROYECTO%20DE%20TITULO/objetos%20proyecto%20de%20titulo/informe_fase_1_definicion_proyecto.md)**:
   ...
   * **Contenido:**
     ...
     * **Parte III:** Arquitectura de software, marco de ciberseguridad (OWASP / ISO 27001), Diagrama de Casos de Uso, Diagrama C4 de Contenedores y Modelo Entidad-Relación relacional.
